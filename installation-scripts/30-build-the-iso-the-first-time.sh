...
echo
	...
	isoLabel='arcolinuxs-xanmod-'$arcolinuxVersion'-x86_64.iso'
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="arcolinuxs-xanmod'
	newname1='iso_name="arcolinuxs-xanmod'

	oldname2='iso_label="arcolinuxs-xanmod'
	newname2='iso_label="arcolinuxs-xanmod'

	oldname3='ArcoLinuxS-Lts-Xanmod'
	newname3='ArcoLinuxS-Lts-Xanmod'

	#hostname
	oldname4='ArcoLinuxS-Lts-Xanmod'
	newname4='ArcoLinuxS-Lts-Xanmod'
